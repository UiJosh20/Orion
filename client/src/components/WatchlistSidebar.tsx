...
export default function WatchlistSidebar() {
  ...
  // Effective Owner Identifier (Google User ID > Device UUID)
  const ownerId = user?.id || deviceUuid;

  // 1. Fetch Watchlist via Dedicated Service Layer
  ...
  // 2. Remove Symbol Mutation via Dedicated Service Layer
          ...
          watchlist.map((item) => {
            ...
            return (
              ...
              >
                ...
                {/* Right: Price Change & Delete Button */}
                <div className="flex items-center gap-2">
                  ...
                  <button
                    onClick={(e) => {
                      e.stopPropagation(); // Don't trigger active symbol switch
